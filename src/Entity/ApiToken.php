...
{      
    ...
    public const SCOPE_POST_CREATE = 'ROLE_POST_CREATE';
    public const SCOPE_POST_EDIT = 'ROLE_POST_EDIT';

    public const SCOPES = [
        self::SCOPE_USER_EDIT => 'Edit User',
        self::SCOPE_POST_CREATE => 'Create Posts',
        self::SCOPE_POST_EDIT => 'Edit Posts',
    ];
