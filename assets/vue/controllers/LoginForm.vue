                    ...
                    <div class="rounded-lg bg-white shadow">
                        ...
                        <div class="flex flex-col items-center space-y-3 p-8">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">Попробуйте: <a href="#" tabindex="-1" @click.prevent="loadEmailField">tarasov@alexey.com</a></p>
                                    </div>
                                </div>
                                <div>
                                    <label class="text-gray-800 text-sm mb-2 block" for="password"></label>
                                    <div class="relative flex flex-col">
                                    <input
                                        class="w-80 text-gray-800 text-sm border-2 border-[#f19574] px-4 py-2 rounded-md outline-none" 
                                        :class="{ 'border-red-600': error }"
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">Попробуйте: <a href="#" tabindex="-1" @click.prevent="loadPasswordField">tarasov</a></p>
                                    </div>
                                </div>
                        </div>
                        <div class="flex flex-row text-center border-t text-sm">
                            <div class="basis-1/2 border-r p-2.5">Создать</div>
                            <div class="basis-1/2 p-2.5">
                                 <button>
                                    Войти
                                </button>
                            </div>
...
const loadEmailField = () => {
    email.value = 'tarasov@alexey.com';
};
const loadPasswordField = () => {
    password.value = 'tarasov';
};
